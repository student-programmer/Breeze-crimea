  ...
  return (
    <div className={home.wrapper}>
      ...
      <div className={home.abautUs}>
        ...
        <h2 className={home.descriptionAboutUs}>
         ...
         <h2 className={home.descriptionAboutUs2}>
            Если вы надумали
          ...
          не приятный запах. </h2>
          <h2 className={home.descriptionAboutUs3}>  Мы рекомендуем раз в год заказывать услугу
          ...
          <h2 className={home.descriptionAboutUs4}>Опыт наших специалистов от 3 лет. </h2> 
